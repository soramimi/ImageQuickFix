...
private slots:
	...
	// QWidget interface
	void on_action_new_from_clipboard_triggered();
	void on_action_edit_rotate_right_triggered();
	void on_action_edit_rotate_left_triggered();
	void on_action_edit_flip_vertical_triggered();
	void on_action_edit_flip_horizontal_triggered();
	void on_action_edit_rotate_180deg_triggered();
